...
This page provides information about the valid indicative distribution map for the ecosystem functional group [**`r efg_name`**](/efg-info/`r efg_code_`.qmd). For older or alternative maps, see [here](/map-info/`r efg_code_`_history.qmd).
